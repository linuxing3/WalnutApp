...
//
void XingRenderer::LoadGameObjects(XingDevice &xingDevice)
{
	std::shared_ptr<XingModel> xingModel =
	    XingModel::createModelFromFile(xingDevice, "models/flat_vase.obj");
	...
	xingModel                        = XingModel::createModelFromFile(xingDevice, "models/smooth_vase.obj");
	...
	xingModel                   = XingModel::createModelFromFile(xingDevice, "models/quad.obj");
